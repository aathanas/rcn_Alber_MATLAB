...
elseif cfg.MC_AF_run
    ...
    CP.IC = RandomizeInhomogeneity(L,cfg.randomflag); % a random inhomogeneity,
...
elseif cfg.Fig7 % you can put your favorite continuous problem here
    ...
    v0 = @(x,y) 0.005 .* exp(-0.06 .* x.^2 - 0.07 .* y.^2) .* ...
...
elseif cfg.Fig9 % you can put your favorite continuous problem here
    ...
    CP.problemname = 'inhomogeneity over stable Gaussian background'; % a string to describe this solution
    ...
    CP.problemname = 'inhomogeneity over weakly unstable Gaussian background'; % a string to describe this solution
